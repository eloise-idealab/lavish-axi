...
export function createArtifactSdk(
  ...
  function showAnnotationCard(target, options = {}) {
    ...
    card.innerHTML =
      ...
      '+Enter to send now</div><div class="lavish-row"><button class="lavish-cancel" type="button">Cancel</button><span class="lavish-spacer"></span><button class="lavish-queue" type="button">Queue</button><button class="lavish-send" type="button">Send</button></div>';
